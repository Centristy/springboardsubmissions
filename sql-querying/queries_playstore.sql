...
SELECT app_name FROM analytics WHERE min_installs > 50 where rating IS NOT NULL ORDER BY reviews DESC;
...
-- 15. Find the app that has the highest proportion of reviews to min_installs, among apps that have been 
-- installed at least 100,000 times. Display the name of the app along with the number of reviews, the min_installs, and the proportion.
