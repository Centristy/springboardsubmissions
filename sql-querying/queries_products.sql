...
INSERT INTO products (name, price, can_be_returned) VALUES ('stool', 124.00, false);
...
INSERT INTO products (name, price, can_be_returned) VALUES ('watch', 30.00, false);
...
SELECT * FROM products WHERE price < 44.00 and price > 22.50;
...
UPDATE prodcuts set can_be_returned = true;